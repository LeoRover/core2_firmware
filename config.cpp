...
void print_config()
{
    ...
    Serial.printf("mag_scale: %f %f %f\r\n", 
        conf.mag_scale[0], conf.mag_scale[1], conf.mag_scale[2]);
    Serial.printf("mag_bias: %f %f %f\r\n", 
        conf.mag_bias[0], conf.mag_bias[1], conf.mag_bias[2]);
...
void load_config()
{
    ...
    {
        Serial.printf("Config checksum incorrect! Default configuration will be used\r\n");
        print_config();
    }
    else
    {
